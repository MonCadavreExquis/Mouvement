...
buttonVideo.style('font-size', p.windowWidth*0.011 + 'px');
...
buttonBoth.style('font-size', p.windowWidth*0.011 + 'px');
...
buttonMvt.style('font-size', p.windowWidth*0.011 + 'px');
...
buttonVid1.style('font-size', p.windowWidth*0.011 + 'px');
...
buttonVid2.style('font-size', p.windowWidth*0.011 + 'px');
...
buttonVid3.style('font-size', p.windowWidth*0.011 + 'px'); 
